...
CREATE TABLE `area_of_interest` (
  ...
  `interest_field_name` varchar(45) DEFAULT NULL,
  KEY `interest_id_idx` (`interest_id`),
  CONSTRAINT `interest_id` FOREIGN KEY (`interest_id`) REFERENCES `angel_helper` (`hid`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2022-11-14 21:10:05
